    ...
    let get_quick_fixes = move || -> Vec<(&'static str, &'static str)> {
        match modal_task_cat.get().as_str() {
            "HVAC" => vec![
                ...
                ("🌡️", "Recharged A/C system"),
                ("💨", "Cleaned blower motor"),
                ("🔌", "Replaced heater core"),
            ],
            "Safety" => vec![
                ("✅", "Passed inspection"),
                ("🔒", "Replaced safety guard"),
                ("⚠️", "Installed warning decal"),
                ("🧰", "Torqued loose fasteners"),
            ],
            "Hydraulics" => vec![
                ("💧", "Topped off hydraulic fluid"),
                ("🔧", "Replaced cylinder seal"),
            ...
            "Electrical" => vec![
                ...
                ("💡", "Replaced work lights"),
            ],
            "Plumbing" => vec![
                ("🔧", "Replaced O-ring"),
                ("🚰", "Cleared coolant line"),
